...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_HelpWidget_t, stringdata) + ofs \
...
const QMetaObject HelpWidget::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_HelpWidget.data,
      qt_meta_data_HelpWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HelpWidget.stringdata))
